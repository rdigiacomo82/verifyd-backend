...
from detection import run_detection   # uses detection.py
...
# ---------------------------------------------------
# ANALYZE ONLY FIRST 10 SECONDS (prevents timeouts)
# ---------------------------------------------------
...
async def upload(file: UploadFile = File(...), email: str = Form(...)):
    ...
    # FIX: unpack tuple
    score, _ = run_detection(clip_path)

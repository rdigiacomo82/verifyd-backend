        ...
        content = [
            {
                ...
                "text": (
                    ...
                    "AI HYPERREAL CHILD / PERSON VIDEOS (score 75+):\n"
                    "AI video generators (Sora, Kling, RunwayML, Pika) frequently produce\n"
                    "hyperrealistic videos of children or people in action — playing, running,\n"
                    "dancing, doing sports — with a glossy, 'too perfect' visual quality.\n"
                    "These are among the HARDEST AI videos to detect visually. Check ALL:\n\n"
                    "- SKIN TEXTURE (most reliable tell for AI child videos):\n"
                    "  REAL children's skin: visible pores, natural color variation (flush on cheeks,\n"
                    "  pallor elsewhere), micro-blemishes, individual hair strands on arms, slight\n"
                    "  shininess only on nose/forehead, sun-kissed asymmetry.\n"
                    "  AI skin: unnaturally smooth and uniform — looks like silicone, wax, or\n"
                    "  a porcelain doll. No pores visible anywhere. Coloring is too even — no\n"
                    "  natural blotchiness. Skin looks like it was airbrushed.\n"
                    "  → If skin looks plastic, waxy, or airbrushed: score 80+\n\n"
                    "- COLOR SATURATION (very reliable AI hyperreal signal):\n"
                    "  REAL phone/camera footage: clothing colors are natural — slightly muted,\n"
                    "  fabric texture visible, colors vary in shade with lighting.\n"
                    "  AI hyperreal: colors are VIVID and OVERSATURATED — like a children's toy\n"
                    "  advertisement. Grass is too green, sky too blue, clothing too saturated,\n"
                    "  entire frame has a 'candy-colored' or 'HDR-overdone' look.\n"
                    "  → If the entire scene looks oversaturated vs real-world colors: score 75+\n\n"
                    "- HAIR DETAIL:\n"
                    "  REAL hair: individual strands visible, flyaways and wisps, natural movement\n"
                    "  with slight lag behind the head, hair edges are irregular and translucent.\n"
                    "  AI hair: rendered as a solid mass or helmet. No individual strands.\n"
                    "  Hair edges are too crisp (hard cutout edge) or too soft (blurred mass).\n"
                    "  Hair moves as a rigid unit with the head, no strand separation.\n"
                    "  → If hair looks like a plastic helmet or painted mass: score 75+\n\n"
                    "- EYES AND FACE:\n"
                    "  REAL children's eyes: natural imperfection — slightly asymmetric, natural\n"
                    "  redness in whites, irregular pupil shape, realistic catchlight position.\n"
                    "  AI eyes: too large, too perfectly round, too symmetric, overly bright\n"
                    "  catchlights, unnaturally white sclera, 'doll eyes' quality.\n"
                    "  Facial features: perfectly proportioned, no asymmetry, no birthmarks,\n"
                    "  no natural imperfections — too beautiful/ideal for a real child.\n"
                    "  → If eyes look like a doll or CGI character: score 80+\n\n"
                    "- MOTION AND PHYSICS:\n"
                    "  REAL children's movement: natural inertia — hair lags behind head movement,\n"
                    "  clothing ripples and deforms with body, feet impact shows ground reaction,\n"
                    "  body bounces with running/jumping steps.\n"
                    "  AI movement: too fluid and smooth — like a CGI character. No weight or\n"
                    "  inertia. Clothing moves as a rigid surface. No ground-impact bounce.\n"
                    "  → If movement lacks physical weight and inertia: score 75+\n\n"
                    "- BACKGROUND AND ENVIRONMENT:\n"
                    "  Real backgrounds: natural depth variation, environmental imperfections,\n"
                    "  consistent real-world lighting on both subject and background.\n"
                    "  AI backgrounds: look like stock photos or rendered 3D environments.\n"
                    "  Lighting direction on the person may not match the background.\n"
                    "  Grass, foliage, and surfaces too perfect and symmetric.\n"
                    "  → If background looks painted or rendered: score 70+\n\n"
                    "COMBINED HYPERREAL SCORING:\n"
                    "If you see oversaturated colors AND smooth skin AND fluid motion: score 80+.\n"
                    "If ANY of the above applies: start at 75 and add for each additional tell.\n"
                    "IMPORTANT: These videos are designed to LOOK real. Be skeptical of portrait\n"
                    "action videos of children — this is a high-frequency AI generation category.\n\n"
